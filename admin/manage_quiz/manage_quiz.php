        ...
        <div class="row">
            ...
            <div class="col-sm-2 col-md-2 sidebar badge-dark" style="margin:inherit;" id="sidebar">
                <ul class="list-group text-white sidebar-list">
                    ...
                    <li class="list-group-item bg-dark"><a href="../manage_courses/manage_courses.php">Quản lý môn học</a></li>
            ...
            <div class="col-md-10 ">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#manage_course">Quản lý câu hỏi</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#menu2">Thêm câu hỏi</a>
                    </li>
                </ul>
                <!-- Nav tabs ends -->
...
-->
    ...
    function validation() {
        ...
        if (name == "") {
            document.getElementById('name_error').innerHTML = "** Vui lòng nhập câu hỏi";
            return false;

        }

        if (desc == "") {
            document.getElementById('desc_error').innerHTML = "** Vui lòng nhập mô tả môn học";
            return false;

        }
        if (img == "") {
            document.getElementById('image_error').innerHTML = "** Vui lòng chọn ảnh";
            return false;
