        ...
        <div class="row">
            ...
            <div class="col-md-10 ">
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#manage_course">Quản lý video</a>
                    </li>
                </ul>
                ...
                <div class="tab-content">
                    <div class="tab-pane container active" id="home">
                        <div class="card-header mt-3 mr-5 bg-white text-info border-0 shadow card1"
                            style="width: 1050px; box-shadow: 1px 1px 1px 1px #ccc"><b>Video của bạn</b></div><br>
                        <div class="row">
                                ...
                                <div class="card mt-3 tab-card">
                                    ...
                                    <div class="tab-content" id="myTabContent">
                                                ...
                                                <div class="card" style="box-shadow: 2px 2px 2px 2px #dfdfdf;">
                                                    ...
                                                    <div class="card-body small">
                                                        <form action="video_add.php" method="post"
                                                            ...
                                                            <div class="form-group">
                                                                <label for="exampleFormControlSelect1">Chọn video
                                                                    :</label>
                                        ...
                                        <div class="tab-pane fade p-3" id="three" role="tabpanel"
                                            ...
                                            <form action=" video_add.php" method="post" enctype="multipart/form-data">
                                                        <div class="form-group">
                                                            <label for="exampleFormControlSelect1">Chọn môn</label>
