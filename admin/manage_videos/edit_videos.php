 ...
 ?>
    ...
    <div class="container-fluid" style="margin-top: 50px;">
        <div class="row">
            ...
            <div class="col-md-10 ">
                <div>
                    <h3 class="text-center mt-2">Quản lý video <?php  echo $_GET['course_name'];  ?> của bạn</h3>
                    <button class="btn btn-primary float-right" data-toggle="modal" data-target="#myModal">Thêm video mới</button><br>
                </div>
                        ...
                        <div class="card shadow mycard" style="width: 18rem; height: 7rem;">
                            ...
                            <div class="card-body shadow" style="background-color: #f1f1f1;">
                                ...
                                <span class="text-danger" style="font-size: 14px; ">
                                    ...
                                    <a href="" class="p-1 text-primary" style="text-decoration: none;">Cập nhật<i
                                            class="fa fa-pencil ml-1"></i></a>

                                    <a href="video_add.php?id=<?php echo $row['video_id']?>&course_name=<?php echo $row['course_name'] ?>&run=delete"
                                        class="p-1 text-danger" name="delete_vid" style="text-decoration: none;">Xóa<i
