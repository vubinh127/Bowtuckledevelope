<?php 
  include("../classes/manage_cmt_class.php");
  $cmt_list=new manage_cmt_class;
  $cmted=$cmt_list->display_cmt();
        ...
        <div class="row">
            <div class="col-sm-2 col-md-2 sidebar badge-dark" style="margin:inherit;" id="sidebar">
                <ul class="list-group text-white sidebar-list">
                    ...
                    <li class="list-group-item bg-dark"><a href="../manage_user/manage_cmt.php">Quản lý bình luận</a></li>
                ...
                <div class="row pt-3">
                    <div class="col-md-8">
                        <table class="table ml-5 bg-white shodow pl-5 table-responsive"
                            ...
                            <p class="ml-5">Danh sách bình luận</p>
                            <thead style="color:black;">
                                <tr>
                                    <th scope="col" hidden>Id</th>
                                    <th scope="col">Người cmt</th>
                            ...
                            <tbody style="color:black;">
                                <form action="delete_user.php" method="post">
                                    <?php 
                                        foreach ($cmted as $cmtdata) {
                                    ?>
                                    <tr>
                                        <th scope="row" hidden>
                                            <?php echo $cmtdata['cid']; ?>
                                        </th>
                                        <td><?php echo $cmtdata['uid']; ?></td>
                                        <td><?php echo $cmtdata['message']; ?></td>
                                        <td><?php echo $cmtdata['date']; ?></td>
                                        <!-- <td><button class="btn btn-danger" name="delete_user" type="submit">Xóa</button></td> -->
                                    </tr>
