...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-dark fixed-top">
        <a class="navbar-brand text-white" href="#">Bowtuckle</a>
        ...
        <div class="row">
            <div class="col-sm-2 col-md-2 sidebar badge-dark" style="margin:inherit;" id="sidebar">
                <ul class="list-group text-white sidebar-list">
                    ...
                    <li class="list-group-item bg-dark "><a href="manage_courses/manage_courses.php">Quản lý môn học</a>
                    </li>
                    <li class="list-group-item bg-dark"><a href="manage_quiz/manage_quiz.php">Quản lý câu hỏi</a></li>
                    <li class="list-group-item bg-dark"><a href="manage_videos/manage_videos.php">Quản lý video</a></li>
                ...
                <div class="row">
                    <div class="col-md-4 mt-3 ml-5">
                        <div class="card shadow " style="width: 18rem; box-shadow: 1px 1px 1px 1px #e1dbdb; border-radius:0px; border-top-left-radius: 0px; cursor:pointer;">
                            ...
                            <div class="card-body">
                                <p class="card-text">
                                    <a href="manage_courses/manage_courses.php" style="text-decoration: none;">Quản lý môn học <i class="fa fa-book ml-3"></i></a>
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 mt-3">
                        <div class="card shadow" style="width: 18rem;cursor:pointer; box-shadow:1px 1px 1px 1px #e1dbdb; border-radius:0px; border-top-left-radius: 0px;">
                            ...
                            <div class="card-body">
                                <p class="card-text ">
                                    <a href="manage_videos/manage_videos.php" style="text-decoration: none; color: orangered">Quản lý video</a>
                                    <i class="fa fa-video-camera ml-3" style="color: orangered"></i>
                                </p>
                            </div>
                        </div>
                                ...
                                <tr>
                                    <td class="mytable1">
                                        <div class="card shadow border-0 " style="width: 15rem; height: 110px; box-shadow: 2px 3px #827171; border-radius:0px; border-top-left-radius: 0px;">
                                            ...
                                            <div class="card-body">
                                                <p class="card-text text-white"><b class="h4">Số ngôn ngữ
                                                    </b><br><span
                                ...
                                <tr>
                                    <td class="mytable2">
                                        <div class="card shadow border-0"
                                            ...
                                            <div class="card-body">
                                                <p class="card-text text-white"><b class="h4">Số video</b><br><span
                ...
                <div class="row ">
                    ...
                    <div class="col-md-3 mt-5 ml-5">
                        <div class="card shadow" style="width: 15rem; height:22rem; box-shadow:1px 1px 1px 1px #e1dbdb; border-radius:0px; border-top-left-radius: 0px;">
                            ...
                            <div class="card-body">
                                <p class="card-text "><a href="manage_quiz/manage_quiz.php" style="text-decoration: none; color: orangered">Quản lý câu hỏi</a></p>
                            </div>
                        </div>
                    </div>
                </div>
