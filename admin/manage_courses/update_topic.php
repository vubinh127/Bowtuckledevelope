    ...
    <div class="container-fluid" style="margin-top: 50px;">
        <div class="row">
            ...
            <div class="col-md-10 ">
                ...
                ?>
                <div class="mt-1">
                    <h3 class="text-center">Cập nhật chủ đề</h3>
                </div>

                <form method="POST" action="verify/verify_changes.php" class="ml-3">
                    <input type="hidden" name="cors_id" value="<?php echo $res['id']; ?>">

                    Nhập tên khóa học:<input type="text" name="coursename" readonly="readonly" class="form-control"
                        value="<?php echo $res['course_name'] ?>"><br>
                    Nhập tên chủ đề :<input type="text" name="topic_name" class="form-control"
                        value="<?php echo $res['topic_name'] ?>">
                    Nhập nội dung:
                    <textarea id="editor" name="editor" class="ckeditor" placeholder="Nhập nội dung"><?php echo $res['description']; ?></textarea>
