                        ...
                        <thead class="thead-dark">
                         ...
                         <tbody>
                            ...
                            ?>
                                <tr>
                                    <td scope="row">
                                        <input type="radio" value="0" name="<?php echo $quest['id']; ?>" />&emsp;<?php echo $quest['opt1']; ?>
                                    </td>
                                </tr>
                            <?php } ?>
                            ...
                            ?>
                                <tr>
                                    <td scope="row">
                                        <input type="radio" value="1" name="<?php echo $quest['id']; ?>" />&emsp;<?php echo $quest['opt2']; ?>
                                    </td>
                                </tr>
                            <?php } ?>
                            ...
                            ?>
                                <tr>
                                    <td scope="row">
                                        <input type="radio" value="2" name="<?php echo $quest['id']; ?>" />&emsp;<?php echo $quest['opt3']; ?>
                                    </td>
                                </tr>
                            <?php } ?>
                            ...
                            ?>
                                <tr>
                                    <td scope="row">
                                        <input type="radio" value="3" name="<?php echo $quest['id']; ?>" />&emsp;<?php echo $quest['opt4']; ?>
                                    </td>
                                </tr>
                            <?php } ?>
                            ...
                            <tr>
                                <td scope="row">
                                <input type="radio" checked="checked" style="display: none;" value="no_attempt" name="<?php echo $quest['id']; ?>" />
                                </td>
                            </tr>
                         </tbody>
                     </table>
