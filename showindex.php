...
<body onload="myfunction()">
    ...
    <section class="slider text-center" id="slider">
        <div class="slider-overlay">
            <div class="slider-content">
                ...
                <div class="cta-div">
                    <a href="login.php" class="btn1">LIÊN HỆ</a>
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="service-wrap text-center">
                        ...
                        <h3><a target="_blank" href="login.php">Các ngôn ngữ</a></h3>
                        <p>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="service-wrap text-center">
                        ...
                        <h3><a target="_blank" href="login.php">Video hướng dẫn</a></h3>
                        <p>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="service-wrap text-center">
                        ...
                        <h3><a target="_blank" href="login.php">Bài tập</a></h3> <!--  exercise/exercise.php -->
                        <p>
                            Bạn có thể làm thử các bài tập tại đây để xem khả năng của bản thân,..
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div class="row text-center">
        <h2><b>Liên hệ chúng tôi</b></h2><br><br>
        <center>
